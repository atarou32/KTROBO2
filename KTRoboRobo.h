...
public:
	...
	virtual void equipRobo(Robo* robo, Graphics* g, MyTextureLoader* tex_loader) = 0;// { return; }; // clone を装備させる
...
public:
	...
	virtual void equipRobo(Robo* robo, Graphics* g, MyTextureLoader* tex_loader) { return; }// { return; }; // clone を装備させる
...
class RoboMovingState_GAMEPAD_JUMPKABE : public RoboState { // enter する前に　setmuki すること
private:
	MYVECTOR3 muki;
public:
