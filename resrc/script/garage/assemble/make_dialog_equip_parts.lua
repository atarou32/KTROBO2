...
gamen2:setPartsGroupMoveTo(equipp_gindex, 400,450,238-68,54,"500")
gamen2:setPartsGroupMoveTo(sellp_gindex, 1400,450,238-68,54,"500")
...
if (hensuu == KTROBO_GARAGE2_HENSUU_ASSEMBLE_PARTS_YES) then
  ...
  KTROBO_MESSAGE_MSG_GARAGE_ASSEMBLE_EQUIP_PARTS, "0.0",true)
